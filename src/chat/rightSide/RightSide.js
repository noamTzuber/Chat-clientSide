...
function RightSide(props) {
    ...
    return (
        <div className="right-container" >
            ...
            <div className="content">
                <Btn setMyUser={props.setMyUser} con = {props.con} id = {props.id} myUser={props.myUser} setContact ={props.setContact} setMessages={props.setMessages} currentConversation={props.currentConversation} />
            </div>
        </div>
    )
}
